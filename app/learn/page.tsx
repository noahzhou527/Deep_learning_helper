...
const courses = [
  { href: "/", code: "01", name: "Neural Notes", tag: "公式与手算复习", text: "从 FNN、CNN、RNN 走到 QKV、缩放、α 权重与 Transformer Block。", color: "violet" },
  { href: "/transformer-map", code: "02", name: "Transformer", tag: "注意力与序列建模", text: "理解 Encoder–Decoder、注意力、多头、FFN、Token 与训练数据。", color: "blue" },
  { href: "/gan", code: "03", name: "GAN", tag: "生成模型", text: "看生成器和判别器如何对抗，以及为何训练不稳定。", color: "coral" },
  { href: "/gpt", code: "04", name: "GPT", tag: "Decoder-only LLM", text: "从下一个 Token 预测走到预训练、对齐和逐词生成。", color: "violet" },
  { href: "/bert", code: "05", name: "BERT", tag: "双向语言理解", text: "理解掩码语言模型、[CLS] 表示与下游微调。", color: "cyan" },
  { href: "/reinforcement-learning", code: "06", name: "强化学习", tag: "从奖励中学习行动", text: "沿 Agent–Environment 循环理解策略、价值与探索。", color: "lime" },
];
